...
class BeliefState(Transmittable):
    ...
    def _init_beliefstate(self):
        ...
        # TODO: Might not start with all info here; revist after writing policy
        belief_state = {"user_acts": [],
                        "slider": {
                            "green": 1.0},
                        'negative_inform': None,
                        "warp drive": {0.0: 1.0},
                        "dials module": {
                            "num_half_dials": None,
                            "num_full_dials": None,
                        ...
                        "button sequence module": {
                            "color_seq": [],        # list of dicts
                            "seq_len": {3: 1.0},
                            "ans": []
                        },
                        "switches module": {
                            "current_switch_ind": {0: 1.0},
                            "color_seq": [],        # list of dicts
                            "ans": []
                        },
                        "button array module": {
    ...
    def reset_module(self, module: str):
        module_defaults = self._init_beliefstate()[module]
        del module_defaults['ans']
        self._history[-1][module] = module_defaults
